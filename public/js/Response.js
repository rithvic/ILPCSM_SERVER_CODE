...
{*/
//	var account = <?php $form = $this->formatjson;print_r($form);?>;
//	var planets = <?php echo json_encode($this->headr); ?>;
...
//$('#account').html(library.json.prettyPrint(planets));
//$('#planets').html(library.json.prettyPrint(account));
//});
